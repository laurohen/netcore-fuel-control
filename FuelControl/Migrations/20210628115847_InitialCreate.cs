        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CnhCategory = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearManufacture = table.Column<string>(nullable: true),
                    MaxTankCapacity = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FuelSupplies_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuelSupplies_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuelSupplies_DriverId",
                table: "FuelSupplies",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_FuelSupplies_VehicleId",
                table: "FuelSupplies",
                column: "VehicleId");
